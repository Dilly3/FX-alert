        ...
        try {
            ...
            if (isGCP) {
                ...
                try {
                    ...
                    (0, google_cloud_logger_1.LogError)("Firestore initialization failed:", error);
                ...
                try {
                    ...
                    (0, google_cloud_logger_1.LogError)("PostgreSQL initialization failed:", error);
                    throw new Error(`PostgreSQL initialization failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
                }
            }
            (0, google_cloud_logger_1.LogInfo)("Initializing stores...", {});
            ...
            appState.forexApi = new forex_api_1.ForexApi(secrets.forex_api_key, appState.currencyStore);
            appState.sendgrid = new sendgrid_1.SendGrid(secrets);
            (0, google_cloud_logger_1.LogInfo)("Stores initialized successfully", {});
            appState.isAppReady = true;
            (0, google_cloud_logger_1.LogInfo)("All systems initialized and ready!", {});
            return { appState, secrets };
        }
        catch (error) {
            (0, google_cloud_logger_1.LogError)("app initialization failed:", error);
            process.exit(1);
        }
    });
}
